...
if (strlen($uid) < 8 || strlen($uid) >= 16)
{
	...
	header('Location: http://www.cs.nmsu.edu/~yulan/SignIn_Staff.html');
	$flag = 0;
	exit;
}
//check the email
...
$officeid = mt_rand(1, 3);
$six_digit_random_number = mt_rand(100000, 999999);
$employid = (string) $six_digit_random_number;
...
//insert into Manager (UserID,EmployeeID,OfficeID)
$query2 = "insert into Staff values ('$uid','$employid','new_staff',$officeid)";

if(mysql_query($query2,$connect))
{
	echo 'Insert Into Staff Successfully~~~~~~.<br>';
	echo '
	<html><body>
...
{
	echo 'ERROR IN INPUT INTO Staff<br>';
	echo mysql_error();
	mysql_close($connect); 
	echo ".<br>";
