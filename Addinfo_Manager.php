...
if (strlen($uid) < 8 || strlen($uid) >= 16)
{
	...
	header('Location: http://www.cs.nmsu.edu/~yulan/SignIn_Manager.html');
	$flag = 0;
	exit;
}
//check the email
...
$query2 = "insert into Manager values ('$uid','$employid',$officeid)";

if(mysql_query($query2,$connect))
{
	echo 'Insert Into Manager Successfully~~~~~~.<br>';
	echo '
	<html><body>
...
{
	echo 'ERROR IN INPUT INTO Manager<br>';
	echo mysql_error();
	mysql_close($connect); 
	echo ".<br>";
